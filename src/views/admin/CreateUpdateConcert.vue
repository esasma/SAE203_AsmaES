<template>
  <main class="mx-6 sm:mx-32 md:mx-44 md:mt-6 lg:mx-64 lg:grid">
    <form @submit.prevent="saveConcert">
      <h1 class="mb-10 font-barlow text-2xl font-bold uppercase text-teal-700">Création d'un concert</h1>
      <div class="mb-10 flex w-full">
        <div class="bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Numéro</div>
        <input
          type="text"
          placeholder="Numéro"
          class="w-full border-[1px] border-gray-400 bg-gray-100 p-2.5 font-barlow text-xl font-bold uppercase text-gray-900"
          v-model="concert.session"
        />
      </div>
      <div class="mb-10 flex w-full">
        <div class="bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Artiste</div>
      ...
      <div class="mb-10 flex w-full">
        <div class="bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Jour</div>
      ...
      <div class="mb-10 flex w-full">
        <div class="bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Horaires</div>
        <input
          type="text"
          placeholder="Horaires du concert"
          class="w-full border-[1px] border-gray-400 bg-gray-100 p-2.5 font-barlow text-xl font-bold uppercase text-gray-900"
          v-model="concert.horaire"
        />
      </div>
      <div class="flex flex-row justify-between gap-5">
        <button type="submit" class="w-full bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">Enregistrer</button>
        <button class="w-full bg-teal-700 p-3 font-barlow text-xl font-bold uppercase text-gray-100">
