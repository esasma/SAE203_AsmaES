<template>
  <main class="mx-6 bg-gray-100 sm:mx-32 md:mx-44 md:mb-20 md:mt-6 lg:m-0 lg:grid lg:grid-cols-6">
    <h1 class="mt-6 text-center font-barlow text-3xl font-bold uppercase text-cyan-700 lg:col-span-full">Liste des Artistes</h1>
    ...
    <table class="col-span-4 mt-10 w-full">
      ...
      <tbody>
        <tr>
          <td class="bg-cyan-500 text-center font-barlow text-xl font-bold uppercase text-white lg:col-span-full">Image</td>
          <td class="bg-cyan-600 text-center font-barlow text-xl font-bold uppercase text-white lg:col-span-full">Nom</td>
