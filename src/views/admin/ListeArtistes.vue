                ...
                <tr v-for="artiste in listeArtistes" :key="artiste.id">
                    ...
                    <td>
                        <div class="flex flex-row justify-center gap-4">
                            <router-link :to="{ name: 'UpdateArtiste', params: { id: artiste.id } }"><img src="/Icon/update.png" alt="modifier" class="w-5"/></router-link>
                            <router-link :to="{ name: 'DeleteArtiste', params: { id: artiste.id } }"><img src="/Icon/delete.png" alt="supprimer" class="w-6"/></router-link>
                        </div>
                    </td>
                </tr>
            </tbody>
